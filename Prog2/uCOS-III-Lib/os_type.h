...
*
*CHANGES:
* 1/30/2012 gpc - Remove definition of OS_ERR for uC/OS-II V3.02 which redefines OS_ERR as an enumerated type.
*
* LICENSING TERMS:
* ---------------
...
// 1/30/2012 gpc typedef   CPU_INT16U      OS_ERR;                      /* Error codes,                                        <16>/32 */
